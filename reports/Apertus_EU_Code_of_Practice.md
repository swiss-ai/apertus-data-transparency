...
This document contains the Code of Practice for the Apertus LLM published by the Swiss National AI Institute (SNAI), a partnership between the two Swiss Federal Institutes of Technology, ETH Zurich and EPFL, on Sept 2nd, 2025\. 
...
Release Version of this CoP: v1
...
Versioned model name: Apertus 1

Release date: Sept 2nd, 2025

Union market release: Sept 2nd, 2025

Model dependencies: None. The model is trained from scratch.
...
Model License: Apache 2.0 (January 2004), accessible at [https://www.apache.org/licenses/LICENSE-2.0](https://www.apache.org/licenses/LICENSE-2.0) 
...
* o	[github.com/swiss-ai/pretrain-code](https://github.com/swiss-ai/pretrain-code)
...
\-	Technical report: \[Available as preprint on arXiv, link TBD\]

**4\) Use**

Acceptable Use Policy: \[TODO insert URL on Hugging Face via “agree and access repository, making sure that there is evidence of user’s consent in writing, as discussed during our call\]
...
[https://huggingface.co/datasets/HuggingFaceFW/fineweb-edu](https://huggingface.co/datasets/HuggingFaceFW/fineweb-edu) (v1.0.0)  
[https://huggingface.co/datasets/epfml/FineWeb-HQ](https://huggingface.co/datasets/epfml/FineWeb-HQ)

[https://huggingface.co/datasets/HuggingFaceTB/dclm-edu](https://huggingface.co/datasets/HuggingFaceTB/dclm-edu)

Multilingual datasets:

[https://huggingface.co/datasets/epfml/FineWeb2-HQ](https://huggingface.co/datasets/epfml/FineWeb2-HQ)  
[https://huggingface.co/datasets/HuggingFaceFW/fineweb-2](https://huggingface.co/datasets/HuggingFaceFW/fineweb-2) (v2.0.1)

Code & math datasets:

[https://huggingface.co/datasets/bigcode/the-stack-dedup](https://huggingface.co/datasets/bigcode/the-stack-dedup) (v1.2)  
[https://huggingface.co/datasets/common-pile/stackv2\_edu\_filtered](https://huggingface.co/datasets/common-pile/stackv2_edu_filtered)  
[https://huggingface.co/datasets/HuggingFaceTB/finemath](https://huggingface.co/datasets/HuggingFaceTB/finemath)  
[https://huggingface.co/datasets/LLM360/MegaMath](https://huggingface.co/datasets/LLM360/MegaMath)
...
[https://huggingface.co/datasets/utter-project/EuroBlocks-SFT-Synthetic-1124](https://huggingface.co/datasets/utter-project/EuroBlocks-SFT-Synthetic-1124)  
[https://huggingface.co/datasets/allenai/tulu-3-sft-olmo-2-mixture-0225](https://huggingface.co/datasets/allenai/tulu-3-sft-olmo-2-mixture-0225)  
...
Data curation methodologies: TODO
